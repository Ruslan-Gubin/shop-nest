...
export class CartDiscountsController {
  ...
  async create(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Скидка на корзину успешно добавлена',
      );
    } catch (error) {
  ...
  > {
    try {
      const cartDiscounts = await this.cartDiscountsService.findAll(
        page,
        limit,
        name,
      );
  ...
  async update(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Скидка на корзину успешно обновлена',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async remove(@Param('id') id: string): Promise<ResponseData<null>> {
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Скидка на корзину успешно удалена',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
