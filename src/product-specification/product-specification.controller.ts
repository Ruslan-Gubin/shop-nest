...
export class ProductSpecificationController {
  ...
  async create(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Значение характеристики товара успешно добавлено',
      );
    } catch (error) {
  ...
  async createMany(
    ...
    try {
      const productSpecifications =
        await this.productSpecificationService.createMany(items);

      return responseData(
        productSpecifications,
        'success',
        [],
        'Значения характеристик товара успешно добавлены',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async findAll(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Список значений характеристик товара получен',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async findByProductId(
    ...
    try {
      const specifications =
        await this.productSpecificationService.findByProductId(
          Number(productId),
        );
      ...
      return responseData(
        ...
        'success',
        [],
        'Характеристики товара получены',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async findOne(
    ...
    try {
      const specification = await this.productSpecificationService.findOne(
        Number(id),
      );
      ...
      return responseData(
        ...
        'success',
        [],
        'Значение характеристики товара получено',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async update(
    ...
    try {
      await this.productSpecificationService.update(
        Number(id),
      ...
      return responseData(
        ...
        'success',
        [],
        'Значение характеристики товара успешно обновлено',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async remove(@Param('id') id: string): Promise<ResponseData<null>> {
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Значение характеристики товара успешно удалено',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async removeByProductId(
    ...
    try {
      await this.productSpecificationService.deleteByProductId(
        Number(productId),
      );
      ...
      return responseData(
        ...
        'success',
        [],
        'Характеристики товара успешно удалены',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
