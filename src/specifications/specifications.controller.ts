...
export class SpecificationsController {
  ...
  > {
    try {
      ...
      const totalCount = await this.specificationsService.getTotalCount(
        name,
        user.sub,
      );
  ...
  async findOne(
    ...
    try {
      const specification = await this.specificationsService.findOne(
        Number(id),
      );
  ...
  async update(
    ...
    try {
      await this.specificationsService.update(
        Number(id),
