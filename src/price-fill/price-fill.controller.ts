  ...
  async create(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Правила автозаполнения успешно добавлено',
      );
    } catch (error) {
  ...
  async findAll(): Promise<ResponseData<PriceFill[] | null>> {
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Список правил автозаполнения получен',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async findOne(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Правила автозаполнения получено',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async update(
    ...
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Правила автозаполнения успешно обновлено',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
  ...
  async remove(@Param('id') id: string): Promise<ResponseData<null>> {
    try {
      ...
      return responseData(
        ...
        'success',
        [],
        'Правила автозаполнения успешно удалено',
      );
    } catch (error) {
      return responseData(null, 'error', [], error);
    }
