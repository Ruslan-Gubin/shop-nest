...
export class CreateProductDto {
  ...
  @ValidateIf(
    (o) =>
      o.seo_title !== undefined && o.seo_title !== null && o.seo_title !== '',
  )
  @MaxLength(255, { message: 'Максимум 255 символов' })
  @MinLength(2, { message: 'Минимум 2 символа' })
  seo_title: string;
  ...
  @ValidateIf(
    (o) =>
      o.seo_description !== undefined &&
      o.seo_description !== null &&
      o.seo_description !== '',
  )
  @MaxLength(255, { message: 'Максимум 255 символов' })
  @MinLength(2, { message: 'Минимум 2 символа' })
  ...
  @ValidateIf(
    (o) => o.og_title !== undefined && o.og_title !== null && o.og_title !== '',
  )
  @MaxLength(255, { message: 'Максимум 255 символов' })
  @MinLength(2, { message: 'Минимум 2 символа' })
  og_title: string;
  ...
  @ValidateIf(
    (o) =>
      o.og_description !== undefined &&
      o.og_description !== null &&
      o.og_description !== '',
  )
  @MaxLength(255, { message: 'Максимум 255 символов' })
  @MinLength(2, { message: 'Минимум 2 символа' })
  ...
  @ValidateIf(
    (o) => o.og_type !== undefined && o.og_type !== null && o.og_type !== '',
  )
  ...
  @ValidateIf(
    (o) => o.keywords !== undefined && o.keywords !== null && o.keywords !== '',
  )
