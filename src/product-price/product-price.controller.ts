...
export class ProductPriceController {
  ...
  async create(
    ...
    try {
      const productPrice = await this.productPriceService.create(
  ...
  async getProductPricesForUser(
    ...
    try {
      const productPrices =
        await this.productPriceService.getProductPricesForUser(
          user.role,
          product_id,
        );
